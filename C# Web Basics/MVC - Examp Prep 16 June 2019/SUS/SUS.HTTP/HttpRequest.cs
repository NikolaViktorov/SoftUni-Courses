...
namespace SUS.HTTP
{
    public class HttpRequest
    {
        ...
        private static void SplitParameters(string parameersAsString, IDictionary<string, string> output)
        {
            var parameters = parameersAsString.Split(new char[] { '&' }, StringSplitOptions.RemoveEmptyEntries);
